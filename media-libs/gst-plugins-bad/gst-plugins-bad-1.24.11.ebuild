...
IUSE="X bzip2 decklink +introspection +orc udev vaapi vnc vulkan wayland"
...
multilib_src_configure() {
	GST_PLUGINS_NOAUTO="bz2 decklink hls ipcpipeline librfb shm va vulkan wayland"
	...
	local emesonargs=(
		...
		$(meson_feature decklink decklink)
